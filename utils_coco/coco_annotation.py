...
#   指向了COCO训练集与验证集图片的路径
#-------------------------------------------------------#
train_datasets_path     = "../../../../Downloads/COCO/train2017"
val_datasets_path       = "../../../../Downloads/COCO/val2017"

#-------------------------------------------------------#
#   指向了COCO训练集与验证集标签的路径
#-------------------------------------------------------#
train_annotation_path   = "../../../../Downloads/COCO/annotations_trainval2017/annotations/instances_train2017.json"
val_annotation_path     = "../../../../Downloads/COCO/annotations_trainval2017/annotations/instances_val2017.json"
