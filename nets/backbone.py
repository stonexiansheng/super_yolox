...
class Backbone(nn.Module):
    def __init__(self, transition_channels, block_channels, n, phi, pretrained=False):
        ...
        self.dark2 = nn.Sequential(
            ...
            Block(transition_channels * 4, block_channels * 2, transition_channels * 4, n=n, ids=ids),
        )
        self.dark3 = nn.Sequential(
            Transition(transition_channels * 4, transition_channels * 4),
            Block(transition_channels * 8, block_channels * 4, transition_channels * 8, n=n, ids=ids),
        )
        self.dark4 = nn.Sequential(
            Transition(transition_channels * 8, transition_channels * 8),
            Block(transition_channels * 16, block_channels * 8, transition_channels * 16, n=n, ids=ids),
        )
        self.dark5 = nn.Sequential(
            Transition(transition_channels * 16, transition_channels * 16),
